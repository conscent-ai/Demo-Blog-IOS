...
class Toast {
    ...
    func showToast(message: String, duration: TimeInterval = 2.0, backgroundColor: UIColor = .black, textColor: UIColor = .white, font: UIFont = UIFont.systemFont(ofSize: 14), cornerRadius: CGFloat = 10, alignment: ToastAlignment = .bottom, size: Double = 40) {
        ...
        let toastSize = CGSize(width: 200, height: size) // Change the size as per your needs

...
@interface CCplugin (SWIFT_EXTENSION(CCPlugin)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface CCplugin (SWIFT_EXTENSION(CCPlugin)) <ASAuthorizationControllerDelegate>
